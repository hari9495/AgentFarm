...
export default function TeamRosterClient({
    ...
    return (
        <>
            {toast && (
                <div className={`fixed top-4 right-4 z-50 flex items-center gap-2.5 rounded-lg px-4 py-3 text-sm font-semibold shadow-lg transition-all ${toast.ok ? "bg-[var(--ok)] text-white" : "bg-[var(--danger)] text-white"}`}>
                    {toast.ok
                        ? <PremiumIcon icon={ShieldCheck} tone="emerald" containerClassName="w-6 h-6 rounded-lg bg-[var(--card)] text-white border-[color:var(--line)]" iconClassName="w-3.5 h-3.5" />
                        : <PremiumIcon icon={ShieldCheck} tone="rose" containerClassName="w-6 h-6 rounded-lg bg-[var(--card)] text-white border-[color:var(--line)]" iconClassName="w-3.5 h-3.5" />}
                    {toast.message}
                </div>
            )}
            ...
            <div className="mt-5 flex flex-wrap items-center justify-between gap-4 border-t border-[color:var(--line)] pt-4">
                ...
                {canManage && (
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-[var(--accent)] hover:bg-[var(--accent)] active:bg-[var(--accent)] text-white text-xs font-bold px-3.5 py-2 transition-colors"
                    >
                ...
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                required
                                className="rounded-lg border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] px-3 py-2 text-sm text-[color:var(--ink)] dark:text-[color:var(--ink)] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[color:color-mix(in_srgb,var(--accent)_40%,transparent)]"
                            />
                        </div>
                        <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <select
                                ...
                                className="rounded-lg border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] px-3 py-2 text-sm text-[color:var(--ink)] dark:text-[color:var(--ink)] focus:outline-none focus:ring-2 focus:ring-[color:color-mix(in_srgb,var(--accent)_40%,transparent)]"
                            >
                    ...
                    <div className="flex justify-end gap-2">
                        <button
                            ...
                            className="rounded-lg border border-[color:var(--line)] dark:border-[color:var(--line)] px-4 py-2 text-xs font-semibold text-[color:var(--ink-soft)] dark:text-[color:var(--ink-muted)] hover:bg-[var(--bg-deep)] dark:hover:bg-[var(--card)] transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            disabled={adding}
                            className="inline-flex items-center gap-2 rounded-lg bg-[var(--accent)] hover:bg-[var(--accent)] disabled:opacity-60 text-white text-xs font-bold px-4 py-2 transition-colors"
                        >
                                    ...
                                    return (
                                        <tr key={m.id} className="hover:bg-[var(--bg-deep)] dark:hover:bg-[var(--card)]/40 transition-colors">
                                            ...
                                            {canManage && (
                                                <td className="px-4 py-3.5">
                                                    {isSuperAdmin ? (
                                                        <span className="inline-flex items-center gap-1.5 rounded-lg border border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)]/50 px-2.5 py-1.5 text-xs font-semibold text-[color:var(--accent)] dark:text-[color:var(--accent)]">
                                                            <ShieldCheck className="w-3.5 h-3.5" />
                                                            Protected role
                                                        </span>
                                                    ) : isSelf ? (
                                                        <span className="inline-flex items-center gap-1.5 rounded-lg border border-[color:var(--line)] dark:border-[color:var(--line)] px-2.5 py-1.5 text-xs font-semibold text-[color:var(--ink-muted)] dark:text-[color:var(--ink-muted)]">
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1.5 rounded-lg border border-[color:color-mix(in_srgb,var(--danger)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--danger)_40%,transparent)] px-2.5 py-1.5 text-xs font-semibold text-[color:var(--danger)] dark:text-[color:var(--danger)] hover:bg-[color-mix(in_srgb,var(--danger)_10%,transparent)] dark:hover:bg-[color-mix(in_srgb,var(--danger)_22%,transparent)]/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1.5 rounded-lg border border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] px-2.5 py-1.5 text-xs font-semibold text-[color:var(--accent)] dark:text-[color:var(--accent)] hover:bg-[color-mix(in_srgb,var(--accent)_10%,transparent)] dark:hover:bg-[color-mix(in_srgb,var(--accent)_22%,transparent)]/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                        >
