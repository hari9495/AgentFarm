                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <motion.h2
                            ...
                            className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-semibold text-[var(--ink)] tracking-tight leading-[1.1]"
                        >
                        ...
                        >
                            {benefits.map((b) => (
                                <li key={b} className="flex items-start gap-3 text-sm text-[var(--body-color)]">
                    ...
                    >
                        ...
                        <div className="relative rounded-xl border border-[var(--hairline)] bg-[var(--surface)] overflow-hidden shadow-2xl shadow-black/20 dark:shadow-black/70">
                            ...
                            <div className="p-4 space-y-2.5">
                                {prEvents.map((ev, i) => (
                                    <motion.div
                                        ...
                                        className="flex items-start gap-3 rounded-lg bg-[var(--surface-card)] border border-[var(--hairline)] p-3"
                                    >
                                        <div
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-0.5">
                                                ...
                                                <span className="text-[10px] text-[var(--ash)] shrink-0">{ev.time}</span>
                                            </div>
                                            <p className="text-xs text-[var(--mute)] truncate">{ev.detail}</p>
                                ...
                                <div className="rounded-lg bg-[rgba(255,197,51,0.04)] border border-[rgba(255,197,51,0.18)] p-3.5">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button className="flex-1 text-xs font-semibold rounded-lg border border-[var(--hairline)] text-[var(--mute)] hover:text-[var(--ink)] hover:bg-black/[0.04] dark:hover:bg-white/[0.04] py-2 transition-colors">
                                            Review diff
                                        </button>
                                    </div>
                                </div>
                            ...
                            {/* Bottom stats strip */}
                            <div className="border-t border-[var(--hairline)] bg-[var(--surface-card)] px-4 py-3 grid grid-cols-3 gap-3">
                                {[
                                    ...
                                    <div key={label} className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-[var(--ash)]">{label}</p>
                                            <p className="text-xs font-semibold text-[var(--ink)]">{value}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
