                ...
                <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-50 via-white to-white">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">Worker Settings</h1>
                                <p className="mt-2 text-slate-600 text-base max-w-lg">Shift hours, approval policy, and notification preferences per AI agent.</p>
                            </div>
