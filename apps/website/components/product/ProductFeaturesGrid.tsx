        ...
        {C.features.map((f, i) => {
          ...
          return (
            <div key={f.title} className="op-lift rounded-2xl p-6" style={{ background: 'var(--op-paper)', border: '1px solid var(--op-line)' }}>
              <div className="mb-4 flex size-12 items-center justify-center rounded-xl" style={{ background: 'var(--op-indigo-soft)' }}>
                <Icon className="size-6" style={{ color: 'var(--op-indigo)' }} />
              </div>
