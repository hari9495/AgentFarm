...
export default function DeveloperMarketplacePage() {
    return (
        <div className="min-h-svh bg-[var(--op-paper)] text-[var(--op-ink-soft)]">
            ...
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-8">
                    ...
                    <div className="flex-1 min-w-0">
                        <span className="inline-flex items-center rounded-full bg-blue-500/10 text-[var(--op-indigo)] border border-blue-500/20 px-3 py-1 text-xs font-semibold mb-4">
                            Engineering
                        </span>
                    ...
                    {CAPABILITIES.map((cap, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-sm text-[var(--op-muted)] leading-relaxed">{cap.detail}</p>
                            </div>
                        );
                    })}
                </div>
            ...
            {/* Sample PR */}
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <h2 className="text-xl font-semibold text-[var(--op-ink)] mb-5">Sample pull request</h2>
                <div className="rounded-xl border border-[var(--op-line)] overflow-hidden">
                    <div className="bg-[var(--op-paper-2)] border-b border-[var(--op-line)] px-5 py-3 flex items-center gap-2">
                        <GitBranch className="h-4 w-4 text-[var(--op-approved)] shrink-0" aria-hidden="true" />
                        <span className="text-sm font-semibold text-[var(--op-ink)] truncate">{SAMPLE_PR.title}</span>
                    </div>
            ...
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-20">
                <div className="relative overflow-hidden rounded-2xl border border-[var(--op-indigo)]/20 bg-[var(--op-paper-2)] p-10 text-center">
