...
const PIPELINE = [
    { label: "Task Intake", value: "24 queued", tone: "text-blue-700 dark:text-blue-300" },
    { label: "Agent Execution", value: "18 running", tone: "text-blue-700 dark:text-blue-300" },
    ...
    { label: "Merge Complete", value: "16 shipped", tone: "text-blue-700 dark:text-blue-300" },
] as const;
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white/85 dark:bg-slate-900/85 p-6 sm:p-8 shadow-xl">
                    <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-8 items-center">
                        <div>
                            <p className="text-xs uppercase tracking-[0.14em] text-blue-700 dark:text-blue-300 font-semibold">Interactive Runtime View</p>
                            ...
                            <div className="mt-6">
                                <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
                                    <motion.div
                                        className="h-2 bg-gradient-to-r from-blue-500 via-blue-500 to-blue-500"
                        ...
                        <div className="h-[340px] sm:h-[420px] rounded-2xl overflow-hidden border border-blue-200/70 dark:border-slate-700 bg-gradient-to-b from-blue-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-4 sm:p-5">
                                    ...
                                    {PIPELINE.map((item, idx) => {
                                        ...
                                        return (
                                            <div key={item.label} className="flex items-center gap-2.5">
                                                <div className={`h-2.5 w-2.5 rounded-full ${active ? "bg-blue-500" : "bg-slate-300 dark:bg-slate-600"}`} />
