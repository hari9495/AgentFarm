                    ...
                    <>
                        ...
                        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden">
                            <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 inline-flex items-center gap-1.5"><Users className="w-4 h-4" /> Permission Matrix</h2>
                                ...
                                <table className="w-full min-w-[840px] text-sm">
                                    <thead>
                                        <tr className="bg-slate-50 dark:bg-slate-800/50">
                                            <th className="text-left px-5 py-3 text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Role</th>
                                            {modules.map((m) => (
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800/70">
                                        {roles.map((role) => (
                                            <tr key={role.name} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                                <td className="px-5 py-3 font-semibold text-slate-900 dark:text-slate-100 whitespace-nowrap">{role.name}</td>
