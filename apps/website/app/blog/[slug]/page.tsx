...
const posts: Post[] = [
    {
        ...
        excerpt: "We're building AI agents that show up to work like real teammates ΓÇö with real identities, real specialisations, and real accountability.",
        body: [
            ...
            "Today we're launching with four specialist roles: Backend Developer, QA Engineer, DevOps Engineer, and Security Engineer. Each has deep, role-specific skills ΓÇö not a general LLM pretending to know your stack.",
    ...
    },
    {
        ...
        body: [
            ...
            "We built our isolation model around three principles: least privilege, blast radius minimisation, and auditability. Least privilege means an agent can only access the resources its current task requires ΓÇö nothing more. Blast radius minimisation means a failure or compromise in one agent cannot cascade to others. Auditability means every action, every API call, every credential access is logged and attributable.",
    ...
    },
    {
        ...
        title: "The Developer Shortage Is Getting Worse ΓÇö Here's the Data",
        category: "Insights",
        ...
        body: [
            ...
            "Three forces are driving the divergence. First, software complexity is increasing faster than developer supply. Modern stacks require specialists in security, reliability, DevOps, and testing ΓÇö roles that are disproportionately hard to hire. Second, developer salaries have reset to a higher baseline after 2022-2023 adjustments, making headcount growth expensive. Third, AI tools are raising the bar for what a 'good' engineer produces ΓÇö which paradoxically increases demand for human engineers who can review and direct AI output.",
            ...
            "We see two emerging responses. Some teams are investing heavily in developer tooling to multiply individual output. Others are exploring whether entire categories of engineering work ΓÇö regression testing, dependency maintenance, security scanning, routine deployments ΓÇö can be handled by specialised agents rather than human engineers.",
            "AgentFarm was built for the second response. Not because human engineers aren't valuable, but because the best ones should be working on the hardest problems ΓÇö not spending half their week on work that can be automated with sufficient reliability.",
    ...
    },
    {
        ...
        excerpt: "A detailed look at how AgentFarm agents interact with GitHub ΓÇö from PR authorship to code review and merge policies.",
        body: [
            ...
            "AgentFarm agents authenticate to GitHub as real organisation members ΓÇö not bot accounts. This means pull requests show the agent's profile photo, status checks run under the agent's identity, and code reviews appear in your existing review workflow. The agent's contributions appear in the org's contribution graph.",
            ...
            "We handle merge policies carefully. By default, agents cannot merge their own PRs ΓÇö a human reviewer or another agent in a different role must approve. You can configure auto-merge for low-risk PRs with passing checks and no pending comments, but it's opt-in and scoped to specific repositories.",
    ...
    },
    {
        ...
        body: [
            ...
            "We avoid a central coordinator to eliminate that as a single point of failure. Instead, agents use optimistic concurrency ΓÇö they claim a task by writing a lock with a TTL. If the agent crashes mid-task, the lock expires and the task is re-queued. Every task is idempotent by design.",
            "Ordering guarantees are maintained at the repository level. We use per-repo task lanes to ensure that two agents don't try to push conflicting commits simultaneously. This is the most complex part of the system ΓÇö and the one we've iterated on the most.",
    ...
    },
    {
        ...
        readTime: "6 min read",
        author: { name: "Priya Nair", role: "Head of Research", initials: "PN" },
        excerpt: "First-pass acceptance rate, rework rate, defect escape rate ΓÇö the metrics that actually tell you if your AI agents are performing.",
        body: [
            ...
            "Our primary quality metric is first-pass acceptance rate: the percentage of agent-produced artefacts (PRs, test suites, config changes) that pass human review without requiring significant rework. For our backend developer agent, this currently sits at 78% ΓÇö meaning roughly 4 in 5 PRs require only minor comments or no changes.",
    ...
    },
    {
        ...
        body: [
            ...
            "On average, engineers report spending 31% of their week on work they consider 'high-value' ΓÇö designing systems, solving hard problems, and doing creative work. The remaining 69% is a mix of code review (18%), meetings (17%), maintenance and bug fixes (15%), testing and QA (11%), and documentation and reporting (8%).",
            ...
            "When we asked engineers which categories they'd most like to hand off, testing (74%), routine maintenance (68%), and security scanning (61%) ranked highest. Code review ranked lowest ΓÇö most engineers see review as valuable human work.",
    ...
    },
    {
        ...
        body: [
            ...
            "The economics are straightforward. A deployed AI engineer costs a fraction of a human engineer ΓÇö today we estimate 8-15% of fully-loaded headcount cost for equivalent output volume on automatable tasks. That ratio will improve as the technology matures.",
            ...
            "This doesn't mean AI engineers replace human engineers. It means the teams that adopt this model can do more with the engineers they have ΓÇö and can hire fewer engineers per unit of output as they scale.",
        ],
    },
    {
        ...
        readTime: "7 min read",
        author: { name: "Sam Okafor", role: "Head of Infrastructure", initials: "SO" },
        excerpt: "Agent configurations, role policies, and approval gates ΓÇö all version-controlled in git and deployed via PR workflow.",
        body: [
            ...
            "AgentFarm supports a GitOps mode where all agent configurations ΓÇö role policies, approval gates, integration settings, shift schedules ΓÇö are stored as YAML files in a repository of your choice. Changes go through PR review. Deployments are automatic on merge.",
    ...
    },
    {
        ...
        body: [
            ...
            "The headline finding: AI security review caught 91% of vulnerabilities that manual review caught, plus an additional 23% that manual review missed. The additional catches were predominantly in third-party dependency CVEs and misconfigured access policies ΓÇö areas where automated, continuous scanning has a natural advantage.",
            ...
            "Mean time from vulnerability introduction to detection was 4.2 hours for AI review versus 11.6 days for manual review. This is the metric that most surprised us ΓÇö the backlog problem in manual security review is severe.",
            "Teams using AI security review also reported that human security engineers shifted their time toward the high-value work: threat modelling, architecture review, and incident response ΓÇö rather than CVE triage and dependency scanning.",
