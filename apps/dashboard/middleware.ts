...
const PUBLIC_PATHS = new Set(['/login', '/signup', '/onboarding', '/design-system', '/ui-kit', '/design-21st', '/design-hybrid', '/command-center-preview', '/design-modern', '/approvals-preview', '/tasks-preview', '/billing-preview', '/agent-detail-preview', '/governance-preview', '/observability-preview', '/connectors-preview', '/settings-preview']);
