...
export async function GET() {
    ...
    const tenants = listCompanyTenants();
    const fleet = listCompanyFleetBots();
    const incidents = listCompanyIncidents();
    const integrations = listCompanyIntegrations();
    const billing = getCompanyBillingSummary();
