    ...
    return (
        <div className="flex flex-col items-end gap-1">
            <button
                ...
                onClick={apply}
                disabled={loading}
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-[color:var(--accent)] dark:text-[color:var(--accent)] border border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] rounded-lg px-3 py-1.5 hover:bg-[color-mix(in_srgb,var(--accent)_10%,transparent)] dark:hover:bg-[color-mix(in_srgb,var(--accent)_22%,transparent)]/20 disabled:opacity-60 transition-colors"
            >
