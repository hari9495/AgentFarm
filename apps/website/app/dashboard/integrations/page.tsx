                ...
                <section className="relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            <div>
                                <h1 className="text-2xl sm:text-[28px] font-semibold text-[color:var(--ink)] tracking-tight leading-tight">Integrations</h1>
                        ...
                        {(["all", ...CATEGORY_ORDER] as const).map((cat) => (
                            <button
                                ...
                                className={`text-xs rounded-full px-3 py-1.5 border font-medium transition ${activeCategory === cat
                                    ? "bg-[var(--accent)] text-[color:var(--ink)] border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)]"
