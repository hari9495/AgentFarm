...
export default function PricingSection() {
    ...
    return (
        <section className="op-section op-light" aria-label="Pricing">
            <div className="op-wrap">
                ...
                >
                    <p className="op-eyebrow mb-4">{pricing.eyebrow}</p>
                    <h2
                ...
                <div className="grid md:grid-cols-3 gap-4 max-w-[860px] mx-auto">
                    {pricing.plans.map((plan, i) => (
                        ...
                        >
                            {plan.highlighted && (
                                <span className="self-start mb-3 text-[11px] font-semibold uppercase tracking-[0.06em] text-[var(--op-indigo)] px-2.5 py-1 rounded-full" style={{ background: "rgba(0,102,204,0.1)" }}>
                                    Most popular
                                </span>
                            )}
                            ...
                            <Link
                                ...
                                className={`mt-6 flex items-center justify-center gap-2 rounded-full py-2.5 text-[15px] font-medium transition-colors ${
                                    plan.highlighted
                                        ? "bg-[var(--op-indigo)] text-white hover:bg-[#0071e3]"
                ...
                <p className="mt-8 text-center text-[14px] text-[#6e6e73]">
                    <Link href="/pricing" className="text-[var(--op-indigo)] hover:text-[#0071e3] transition-colors">
                        {pricing.linkLabel}
                    </Link>
                </p>
            </div>
