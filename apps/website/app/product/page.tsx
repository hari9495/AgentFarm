...
export const metadata: Metadata = {
    ...
    description: "Explore AgentFarm's AI worker capabilities, integrations, and features.",
};
...
const features = [
    {
        ...
        description:
            "AI backend workers that implement features, write APIs, handle DB migrations, and review PRs with full codebase context.",
    ...
    },
    {
        ...
        description:
            "DevOps agents that manage CI/CD pipelines, Kubernetes clusters, and deployments without human intervention.",
    ...
    },
    {
        ...
        description:
            "Assign a task via Slack or Jira and your AI worker starts executing in under 30 seconds.",
    ...
    },
    {
        ...
        description:
            "Branch creation, PR authoring, code review comments, and merge — all driven natively by your AI workers.",
...
const outcomes = [
    "Teams report first PR from AI worker within 15 minutes of setup",
    "Average 18+ additional pull requests shipped per worker per week",
    "Security scan on every PR — zero manual security review needed",
        ...
        <div className="site-shell">
            ...
            <section className="relative overflow-hidden">
                <img
                    ...
                    alt="AgentFarm product dashboard showing AI workers in action"
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-5 text-xl text-slate-300 leading-relaxed">
                                AgentFarm gives you a full suite of AI engineering workers — purpose-built
                                for real software development workflows, not just copilots.
                            </p>
                    ...
                    <div className="relative overflow-hidden rounded-3xl">
                        ...
                        <div className="relative py-16 px-10 text-center text-white">
                            <h2 className="text-3xl font-bold mb-4">
                                Ready to put AI workers on your team?
                            </h2>
