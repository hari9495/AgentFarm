...
const VERDICT: Record<Result['effect'], { color: string; label: string }> = {
    deny: { color: '#2563EB', label: 'DENIED by customer policy' },
...
export default function PolicySimulatorPanel() {
    ...
    return (
        <div style={{ ...card, marginTop: 16 }}>
            ...
            {error && <div style={{ marginTop: 12, display: 'flex', gap: 8, alignItems: 'center', fontSize: 13, color: '#2563EB' }}><AlertCircle size={15} />{error}</div>}
