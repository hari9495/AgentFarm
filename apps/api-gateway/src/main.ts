...
await registerProspectsRoutes(app, { getSession: (request) => readSession(request), prisma: prisma as never });
await registerSalesConfigRoutes(app, { getSession: (request) => readSession(request), prisma: prisma as never });
await registerOutreachRoutes(app, { getSession: (request) => readSession(request), prisma: prisma as never });
