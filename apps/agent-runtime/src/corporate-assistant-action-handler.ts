...
import {
    ...
    sendComposedEmail,
    classifyEmailIntent,
} from './corporate-assistant/email-composer.js';
import {
    checkCalendarAvailability,
    scheduleCalendarEvent,
    cancelCalendarEvent,
} from './corporate-assistant/calendar-scheduler.js';
import {
    createInternalDocument,
    updateExistingDocument,
} from './corporate-assistant/document-preparer.js';
import {
    classifyEscalationDomain,
    buildEscalationNote,
} from './corporate-assistant/escalation-router.js';
import { sendMessage } from './corporate-assistant/message-sender.js';
