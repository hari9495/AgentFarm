                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    {connector.authMethod === "oauth2" && (
                        <div className="rounded-lg border border-sky-200 dark:border-sky-800 bg-sky-50 dark:bg-sky-900/20 p-4">
                            <p className="text-sm font-semibold text-sky-700 dark:text-sky-300 mb-1">OAuth 2.0 Authentication</p>
                            ...
                            {connector.oauthScopes && (
                                <ul className="mt-2 space-y-0.5">
                                    {connector.oauthScopes.map((s) => (
                                        <li key={s} className="text-xs font-mono bg-sky-100 dark:bg-sky-900/40 text-sky-700 dark:text-sky-300 rounded px-1">• {s}</li>
                                    ))}
                                </ul>
                            )}
                        </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 bg-sky-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-sky-700 disabled:opacity-50 transition"
                        >
...
function AvailableCard({
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 flex items-center gap-3 hover:border-sky-300 dark:hover:border-sky-700 transition-colors">
            ...
            {connector.connected ? (
                ...
                <button onClick={onAdd} className="flex items-center gap-1 text-xs bg-sky-600 text-white rounded-lg px-3 py-1.5 hover:bg-sky-700 transition font-medium">
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4">
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            ...
                            <select
                                ...
                                className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
