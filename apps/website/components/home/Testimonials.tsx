        ...
        <section className="op-section op-dark" aria-label="Customer testimonials">
            <div className="op-wrap">
                ...
                >
                    ...
                    <p className="mt-4 mx-auto max-w-md text-[17px] text-[#98989d]" style={{ lineHeight: 1.47, letterSpacing: "-0.022em" }}>
                        ...
                        >
                            ...
                            <div className="flex gap-0.5">
                                {Array.from({ length: item.stars }).map((_, si) => (
                                    <Star key={si} className="w-3.5 h-3.5 fill-[#2997ff] text-[#2997ff]" />
                                ))}
                            </div>

                            {/* Metric */}
                            <p className="text-[12px] font-semibold uppercase tracking-[0.05em] text-[#2997ff]">
                                {item.metric}
                            </p>

                            {/* Quote */}
                            <p className="text-[15px] text-[#e5e5ea] leading-relaxed flex-1">
                            ...
                            <div className="flex items-center gap-3 pt-2" style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
                                ...
                                <div>
                                    <p className="text-[14px] font-semibold text-white" style={{ letterSpacing: "-0.01em" }}>{item.name}</p>
                                    <p className="text-[12px] text-[#98989d]">{item.role}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
