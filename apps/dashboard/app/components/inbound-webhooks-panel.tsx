        ...
        <section className="card" style={{ marginTop: '1rem' }}>
            ...
            {activeTab === 'sources' && (
                <div>
                        ...
                        <div style={{ background: 'var(--ok-bg)', border: '1px solid rgba(26,122,74,0.25)', borderRadius: 14, padding: '16px 18px', marginBottom: 14, position: 'relative' }}>
                            ...
                            {newWebhookUrl && (
                                <div style={{ marginBottom: 10 }}>
                                    ...
                                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                                        ...
                                        <button onClick={() => handleCopy(newWebhookUrl, 'new-url')} style={{ fontSize: 12, padding: '6px 14px', borderRadius: 9999, cursor: 'pointer', background: 'var(--card)', color: 'var(--accent)', border: '1px solid rgba(37, 99, 235,0.3)', fontWeight: 600, whiteSpace: 'nowrap' }}>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                                    ...
                                    <button onClick={() => handleCopy(newSecret, 'secret')} style={{ fontSize: 12, padding: '6px 14px', borderRadius: 9999, cursor: 'pointer', background: 'var(--card)', color: 'var(--accent)', border: '1px solid rgba(37, 99, 235,0.3)', fontWeight: 600, whiteSpace: 'nowrap' }}>
                    ...
                    {showAddForm && (
                        <div style={{ border: '1px solid rgba(37, 99, 235,0.25)', borderRadius: 16, background: 'var(--card)', padding: '18px 20px', marginBottom: 14, boxShadow: '0 0 0 4px rgba(37, 99, 235,0.04)' }}>
                                            ...
                                            <div style={{ flex: 1, minWidth: '200px' }}>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.35rem' }}>
                                                    ...
                                                    <button
                                                        ...
                                                        style={{ fontSize: 11, padding: '3px 9px', borderRadius: 9999, cursor: 'pointer', background: 'var(--card)', color: 'var(--accent)', border: '1px solid rgba(37, 99, 235,0.3)', fontWeight: 600 }}
                                                    >
            ...
            {activeTab === 'rules' && (
                <div>
                    ...
                    {showRuleForm && (
                        <div style={{ border: '1px solid rgba(37, 99, 235,0.25)', borderRadius: 16, background: 'var(--card)', padding: '18px 20px', marginBottom: 14 }}>
