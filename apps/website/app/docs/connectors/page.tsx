...
export const metadata: Metadata = {
    title: "Connectors — AgentFarms Docs",
    description: "All 18 AgentFarms connectors — GitHub, Jira, Slack, Salesforce, Gmail, and more. OAuth setup, available actions, and scoping guide.",
