...
const SPEAKER_STATE_UI: Record<SpeakerState, { label: string; dot: string; bg: string; color: string }> = {
    'idle':                 { label: 'Idle',                   dot: '○', bg: 'var(--bg)', color: 'var(--ink-muted)' },
    'agent-speaking':       { label: 'Agent speaking',         dot: '●', bg: 'var(--ok-bg)', color: 'var(--ok)' },
    'agent-listening':      { label: 'Agent listening',        dot: '◉', bg: 'var(--info-bg)', color: 'var(--info)' },
    'participant-speaking': { label: 'Participant speaking',   dot: '●', bg: 'var(--warn-bg)', color: 'var(--warn)' },
    'transcribing':         { label: 'Transcribing',           dot: '◌', bg: 'var(--ok-bg)', color: 'var(--ok)' },
    'ended':                { label: 'Session ended',          dot: '■', bg: 'var(--bg)', color: 'var(--ink-muted)' },
};
