    ...
    return (
        <div className="rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] p-5">
            <div className="flex items-start justify-between gap-3">
                <div>
                    <p className="text-base font-semibold text-[color:var(--ink)] dark:text-[color:var(--ink)] flex items-center gap-2">
            ...
            {loading ? (
                <p className="mt-4 text-xs text-[color:var(--ink-muted)] dark:text-[color:var(--ink-muted)] inline-flex items-center gap-2">
                    <PremiumIcon icon={LoaderCircle} tone="slate" containerClassName="w-6 h-6 rounded-lg bg-[var(--bg-deep)] dark:bg-[var(--card)] text-[color:var(--ink-soft)] dark:text-[color:var(--ink-muted)]" iconClassName="h-3.5 w-3.5 animate-spin" /> Loading deployment...
                </p>
            ) : error ? (
                    ...
                    <div className="flex items-center gap-2 pt-1">
                        {deployment.status === "failed" ? (
                            <button
                                ...
                                className="inline-flex items-center rounded-lg border border-[color:color-mix(in_srgb,var(--ok)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--ok)_40%,transparent)] px-2.5 py-1.5 text-xs font-semibold text-[color:var(--ok)] dark:text-[color:var(--ok)] hover:bg-[color-mix(in_srgb,var(--ok)_10%,transparent)] dark:hover:bg-[color-mix(in_srgb,var(--ok)_22%,transparent)]/20 disabled:opacity-60"
                            >
                        ...
                        {deployment.status === "queued" || deployment.status === "running" ? (
                            <button
                                ...
                                disabled={actionPending !== null}
                                className="inline-flex items-center rounded-lg border border-[color:color-mix(in_srgb,var(--danger)_40%,transparent)] dark:border-[color:color-mix(in_srgb,var(--danger)_40%,transparent)] px-2.5 py-1.5 text-xs font-semibold text-[color:var(--danger)] dark:text-[color:var(--danger)] hover:bg-[color-mix(in_srgb,var(--danger)_10%,transparent)] dark:hover:bg-[color-mix(in_srgb,var(--danger)_22%,transparent)]/20 disabled:opacity-60"
                            >
