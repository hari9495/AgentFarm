...
const classFor = (value: string) => {
    ...
    if (value === "Edit") return "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300";
                    ...
                    <>
                        ...
                        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden">
                            <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 inline-flex items-center gap-1.5"><PremiumIcon icon={Users} tone="sky" containerClassName="w-6 h-6 rounded-lg bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400" iconClassName="w-3.5 h-3.5" /> Permission Matrix</h2>
                                <button className="rounded-lg bg-blue-600 text-white dark:bg-slate-100 dark:text-slate-900 px-3 py-1.5 text-xs font-semibold">Create custom role</button>
                            </div>
                            {/* Legend */}
                            <div className="px-5 py-2.5 border-b border-slate-100 dark:border-slate-800 flex flex-wrap items-center gap-3">
                                {[
                                    ...
                                    { label: "Edit", cls: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300" },
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full min-w-[840px] text-sm">
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800/70">
                                        {roles.map((role) => (
                                            <tr key={role.name} className="hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors group">
                                                <td className="px-5 py-3 font-semibold text-slate-900 dark:text-slate-100 whitespace-nowrap sticky left-0 bg-white dark:bg-slate-900 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/10 z-10 transition-colors">{role.name}</td>
