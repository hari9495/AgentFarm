        ...
        <div className="min-h-svh bg-[var(--bg-deep)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-6 space-y-6">
                ...
                <section className="relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            <div>
                                <h1 className="text-2xl sm:text-[28px] font-semibold text-[color:var(--ink)] tracking-tight leading-tight">Notifications</h1>
                ...
                {notifications.length === 0 ? (
                    <div className="rounded-xl border border-dashed border-[color:var(--line-strong)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] px-6 py-14 text-center">
                        <div className="mx-auto w-12 h-12 rounded-lg bg-[var(--bg-deep)] dark:bg-[var(--card)] flex items-center justify-center mb-4">
                    ...
                    <div className="space-y-3">
                        {notifications.map((notif) => {
                            ...
                            return (
                                <div
                                    key={notif.id}
                                    className={`rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] overflow-hidden ${style.container} transition-opacity ${notif.read ? "opacity-70" : ""}`}
                                >
                                    <div className="flex items-start gap-3 px-5 py-4">
                                        <PremiumIcon icon={Icon} tone={tone} containerClassName="w-8 h-8 rounded-lg shrink-0 mt-0.5" iconClassName="w-4 h-4" />
