                ...
                <section className="relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="flex items-center gap-2 rounded-lg bg-[var(--ok)]/10 border border-[color:color-mix(in_srgb,var(--ok)_40%,transparent)]/20 px-3 py-1.5 text-xs font-semibold uppercase tracking-widest text-[color:var(--ok)]">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            <div>
                                <h1 className="text-2xl sm:text-[28px] font-semibold text-[color:var(--ink)] tracking-tight leading-tight">Billing & plan</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] p-5">
                        <div className="flex items-center justify-between mb-4">
                            <PremiumIcon icon={TrendingUp} tone="emerald" containerClassName="w-10 h-10 rounded-lg bg-[color-mix(in_srgb,var(--ok)_10%,transparent)] dark:bg-[color-mix(in_srgb,var(--ok)_22%,transparent)]/50 text-[color:var(--ok)] dark:text-[color:var(--ok)]" iconClassName="w-5 h-5" />
                            {trendChangePct !== null && (
                    ...
                    <div className="rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] p-5">
                        <div className="flex items-center justify-between mb-4">
                            <PremiumIcon icon={Users} tone="sky" containerClassName="w-10 h-10 rounded-lg bg-[color-mix(in_srgb,var(--accent)_10%,transparent)] dark:bg-[color-mix(in_srgb,var(--accent)_22%,transparent)]/50 text-[color:var(--accent)] dark:text-[color:var(--accent)]" iconClassName="w-5 h-5" />
                            {seatPct !== null && (
                    ...
                    <div className="rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] overflow-hidden">
                        ...
                        <div className="p-4 space-y-3">
                            {[
                                ...
                                <div key={label} className="flex items-center justify-between rounded-lg border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--bg-deep)] dark:bg-[var(--card)]/50 px-4 py-3 gap-3">
                                    <div className="flex items-center gap-2.5 min-w-0">
                                        <PremiumIcon icon={Icon} tone="slate" containerClassName="w-6 h-6 rounded-lg bg-[var(--bg-deep)] dark:bg-[var(--card)] text-[color:var(--ink-soft)] dark:text-[color:var(--ink-muted)] shrink-0" iconClassName="w-4 h-4" />
