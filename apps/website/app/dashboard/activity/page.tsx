                ...
                <section className="relative overflow-hidden rounded-2xl bg-slate-950">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight">Live Activity</h1>
                                <p className="mt-2 text-slate-400 text-base max-w-lg">Real-time feed of every action, task, and event across all AI teammates.</p>
                            </div>
                        </div>
                    </div>
                </section>
