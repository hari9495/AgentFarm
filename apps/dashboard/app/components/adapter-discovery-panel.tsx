...
function statusDot(status: AdapterStatus) {
    ...
    if (status === 'registered')   return { color: 'var(--accent)',   bg: 'rgba(45, 138, 138,0.08)',   border: 'rgba(45, 138, 138,0.2)',   label: 'Registered'   };
...
function RegisterForm({
    ...
    return (
        <div style={{ border: '1px solid rgba(45, 138, 138,0.25)', borderRadius: 18, background: 'var(--card)', boxShadow: '0 0 0 4px rgba(45, 138, 138,0.04)', marginBottom: 20, overflow: 'hidden' }}>
            {/* Header */}
            ...
            <div style={{ padding: '20px' }}>
                ...
                {step === 2 && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        {/* Summary */}
                        <div style={{ padding: '12px 14px', borderRadius: 12, background: 'rgba(45, 138, 138,0.04)', border: '1px solid rgba(45, 138, 138,0.15)' }}>
