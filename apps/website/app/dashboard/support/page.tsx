            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 py-6 space-y-6">
                ...
                <section className="relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                        <div>
                            <div className="flex items-center gap-2 rounded-lg bg-[color-mix(in_srgb,var(--accent)_10%,transparent)] border border-[color:color-mix(in_srgb,var(--accent)_40%,transparent)] px-3 py-1.5 text-xs font-semibold uppercase tracking-widest text-[color:var(--accent)] w-fit mb-4">
                            ...
                            <h1 className="text-2xl sm:text-[28px] font-semibold text-[color:var(--ink)] tracking-tight leading-tight">Support &amp; issues</h1>
                ...
                {showForm && (
                    <form onSubmit={handleSubmit} className="rounded-xl border border-[color:var(--line)] dark:border-[color:var(--line)] bg-[var(--card)] dark:bg-[var(--card)] p-5 space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            <button type="submit" disabled={submitting} className="rounded-lg bg-[var(--accent)] dark:bg-[var(--card)] text-[color:var(--ink)] dark:text-[color:var(--ink)] text-sm font-bold px-4 py-2 disabled:opacity-60">
                                        ...
                                        {isOpen && (
                                            <div className="px-5 pb-5 pl-[2.1rem] space-y-3">
                                                ...
                                                {detail?.diagnosisReport && (
                                                    <div className="rounded-lg bg-[var(--bg-deep)] dark:bg-[var(--card)]/50 px-3 py-2.5">
                                                ...
                                                {detail?.resolutionNotes && (
                                                    <div className="rounded-lg bg-[color-mix(in_srgb,var(--ok)_10%,transparent)] dark:bg-[color-mix(in_srgb,var(--ok)_22%,transparent)]/20 px-3 py-2.5">
