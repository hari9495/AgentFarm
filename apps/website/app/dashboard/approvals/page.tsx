                ...
                <section className="relative overflow-hidden rounded-[4px] border border-[color:var(--line)] bg-gradient-to-br from-[color-mix(in_srgb,var(--accent)_8%,transparent)] via-[var(--card)] to-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xs text-[color:var(--ink-muted)]">Pending Actions</span>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-extrabold text-[color:var(--ink)] tracking-tight leading-tight">Approval Inbox</h1>
                                <p className="mt-2 text-[color:var(--ink-soft)] text-base max-w-lg">All pending approval requests across your organisation.</p>
                            </div>
                        </div>
                    </div>
                </section>
