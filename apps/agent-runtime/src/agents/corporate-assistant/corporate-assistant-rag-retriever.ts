...
export async function buildCorporateRagContext(query: CorporateRagQuery, gatewayBaseUrl: string, serviceToken: string, workspaceId: string): Promise<CorporateRagContext> {
