                ...
                <section className="relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-gradient-to-br from-[color-mix(in_srgb,var(--accent)_8%,transparent)] via-[var(--card)] to-[var(--card)]">
                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="flex items-center gap-2 rounded-lg bg-[var(--ok)]/10 border border-[color:color-mix(in_srgb,var(--ok)_40%,transparent)]/20 px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-[color:var(--ok)]">
