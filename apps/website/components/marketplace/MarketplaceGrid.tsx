...
// ─── DeptSection (used in "All domains" view) ─────────────────────────────────
...
export default function MarketplaceGrid() {
    ...
    // Bots matching plan/availability/search (dept-agnostic) — used for "All" view sections
        ...
        <div className="bg-white dark:bg-slate-950">
            ...
            <section className="py-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* ── Content: All domains — grouped sections ──────────── */}
                    {dept === "all" && (
                        <div>
                            {activeDepts.map((d) => {
                    ...
                    {/* ── Content: Single domain — full grid ───────────────── */}
