// Prevents the support agent from leaking proprietary information to customers.
//
// Two responsibilities:
//   1. detectProprietaryInfoRequest()  — catches customer messages asking for code/internals
//   2. sanitizeResponseForCustomer()   — strips code, paths, stack traces from outgoing text
