        ...
        <section className="card" style={{ marginBottom: '2rem' }}>
            ...
            <form onSubmit={(e) => void handleCreate(e)}
                ...
                <button type="submit" disabled={creating}
                    style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '0.46rem 1rem', background: 'var(--brand, #2C8A8A)', color: 'var(--card)', border: 'none', borderRadius: 6, fontSize: '0.875rem', fontWeight: 600, cursor: creating ? 'not-allowed' : 'pointer', opacity: creating ? 0.7 : 1 }}>
