                                            ...
                                            <tr key={u.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                                                ...
                                                <td className="px-4 py-3.5">
                                                    <span className={`inline-flex items-center gap-1.5 text-xs font-semibold rounded-full px-2.5 py-1 ${isSuperAdmin
                                                        ...
                                                        {isSuperAdmin ? <PremiumIcon icon={ShieldCheck} tone="violet" containerClassName="w-5 h-5 rounded-md bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300" iconClassName="w-3 h-3" /> : isAdmin ? <PremiumIcon icon={Shield} tone="violet" containerClassName="w-5 h-5 rounded-md bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300" iconClassName="w-3 h-3" /> : <PremiumIcon icon={Users} tone="slate" containerClassName="w-5 h-5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300" iconClassName="w-3 h-3" />}
                                                ...
                                                <td className="px-4 py-3.5">
                                                    {isSuperAdmin ? (
                                                        <span className="inline-flex items-center gap-1.5 rounded-lg border border-blue-200 dark:border-blue-900/50 px-2.5 py-1.5 text-xs font-semibold text-blue-700 dark:text-blue-300">
                                                            <PremiumIcon icon={ShieldCheck} tone="violet" containerClassName="w-5 h-5 rounded-md bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300" iconClassName="w-3 h-3" />Protected role
                                                        </span>
                                                    ) : isAdmin ? (
                                                        <button
                                                            disabled={busy}
                                                        ...
                                                        >
                                                            <PremiumIcon icon={UserCheck} tone="violet" containerClassName="w-5 h-5 rounded-md bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400" iconClassName="w-3 h-3" />
