...
export async function GET(
    ...
    const targetUrl = `${getApiBaseUrl()}/v1/agents/${botId}/versions`;
...
export async function POST(
    ...
    const { botId } = await params;
    // POST to /versions proxies to the snapshot endpoint
    const targetUrl = `${getApiBaseUrl()}/v1/agents/${botId}/versions/snapshot`;
