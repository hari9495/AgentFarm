                    ...
                    <div className="relative px-6 sm:px-8 py-6 sm:py-8">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                            ...
                            <div className="flex flex-wrap items-center gap-3 shrink-0">
                                <ButtonLink href="/dashboard/security/api-keys" size="sm" variant="outline" className="!bg-white/10 !text-white !border-white/20 hover:!bg-white/20 hover:!border-white/30">
                                    API keys
                                </ButtonLink>
                                <ButtonLink href="/dashboard/settings" size="sm" variant="outline" className="!bg-white/10 !text-white !border-white/20 hover:!bg-white/20 hover:!border-white/30">
                                    Account settings
                                </ButtonLink>
                            </div>
                        </div>
